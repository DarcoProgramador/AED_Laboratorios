...
public class Directa extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        Title.setText("Seleccion Directa");
        add(Title, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 50, -1, -1));
    ...
    //Metodo de la Seleccion Directa
    public void metodoSeleccionDirecta()
    {  
        int i, j, menor, pos, aux;
          for (i = 0; i < Inicio.n; i++) {      // tomamos como menor el primero
                menor = ordenado[i];                       // de los elementos que quedan por ordenar                    
                pos = i;                            // y guardamos su posición
                
                for (j = i + 1; j < Inicio.n+1; j++){ // buscamos en el resto
                      if (ordenado[j] < menor) {           // del array algún elemento
                          menor = ordenado[j];             // menor que el actual
                          pos = j;
                      }
                }
