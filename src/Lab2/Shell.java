...
public class Shell extends javax.swing.JPanel {
    ...
    public Shell(Arreglo_Desordenado A) 
    {
        initComponents();
        Inicio = A;
    ...
    {  
        ...
        int salto, aux, i, tam = Inicio.n+1;
        boolean cambios;
        ...
        for (salto = tam / 2; salto != 0; salto /= 2) {
            ...
            while (cambios) {   // Mientras se intercambie algún elemento                                         
                cambios = false;
                for (i = salto; i < tam; i++)   // se da una pasada
                {
                    if (ordenado[i - salto] > ordenado[i]) {       // y si están desordenados
                        aux = ordenado[i];                  // se reordenan
                        ordenado[i] = ordenado[i - salto];
                        ordenado[i - salto] = aux;
