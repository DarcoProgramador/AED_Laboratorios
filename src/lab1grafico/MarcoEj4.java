 ...
 * @author Thebeast
 */
public class MarcoEj4 extends javax.swing.JFrame {
int tam = 15;
int n = -1, Cam = 0;
...
DefaultTableModel modelo2 = new DefaultTableModel(); 
    ...
    private void initComponents() {
        ...
        AñosCambiar = new javax.swing.JTextField();
        ...
        DireccionAñadir = new javax.swing.JTextField();
        jLabel25 = new javax.swing.JLabel();
        AñosAñadir = new javax.swing.JTextField();
        ...
        jLabel8.setText("Cambiar Antiguedad");
        EstadoCliente.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, -1));
        ...
        MostrarClientes.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, -1, -1));
        ...
        Desabilitado1.setText("Años Antiguedad");
        Cambiar.add(Desabilitado1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 160, -1, -1));
        ...
        AñosCambiar.setBackground(new java.awt.Color(51, 51, 51));
        AñosCambiar.setForeground(new java.awt.Color(255, 255, 255));
        AñosCambiar.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                AñosCambiarKeyTyped(evt);
            }
        });
        Cambiar.add(AñosCambiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 200, 110, -1));
        ...
        NuevoEmpleado.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 150, -1, -1));
        ...
        NuevoEmpleado.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 60, -1, -1));
        ...
        NuevoEmpleado.add(ApellidoAñadir, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 90, 90, -1));
        ...
        NuevoEmpleado.add(EdadAñadir, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 90, 90, -1));
        ...
        NuevoEmpleado.add(Sexo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 180, -1, -1));
        ...
        NuevoEmpleado.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 150, -1, -1));

        DireccionAñadir.setBackground(new java.awt.Color(51, 51, 51));
        DireccionAñadir.setForeground(new java.awt.Color(255, 255, 255));
        NuevoEmpleado.add(DireccionAñadir, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, 90, -1));

        jLabel25.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel25.setForeground(new java.awt.Color(0, 0, 0));
        jLabel25.setText("Años Antiguedad");
        NuevoEmpleado.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 140, 150, 30));

        AñosAñadir.setBackground(new java.awt.Color(51, 51, 51));
        AñosAñadir.setForeground(new java.awt.Color(255, 255, 255));
        AñosAñadir.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                AñosAñadirKeyTyped(evt);
            }
        });
        NuevoEmpleado.add(AñosAñadir, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 180, 90, -1));
    ...
    private void AñadirBotonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AñadirBotonMousePressed
        if (NombreAñadir.getText().equals("") || ApellidoAñadir.getText().equals("") || EdadAñadir.getText().equals("") || DireccionAñadir.getText().equals("") || AñosAñadir.getText().equals(""))
        {
        ...
        {
            if (n == -1)
            { /*Agrega al empleado en la posici�n 0 cuando no hay datos*/
		n++;
		...
		Años[n]= Integer.parseInt(AñosAñadir.getText());
            ...
            { /*Agrega al empleado cuando hay otro empleado existente*/
    ...
    private void EliminarButonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EliminarButonMousePressed
       if (NombreEliminar.getText().equals(""))
       {
    ...
    private void BuscarModificarButon1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BuscarModificarButon1MousePressed
        ...
        {
            if(n>-1){
			String nomB= NombreModificar.getText();
			int pos = Busca(nombre,nomB,n);
    ...
    private void ActualizarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ActualizarMousePressed
        if (AñosCambiar.getText().equals(""))
        {
            JOptionPane.showMessageDialog(null,"Hay campos vacios");
        }
        else
        {
            Años[Cam]= Integer.parseInt(AñosCambiar.getText());
    ...
    private void AñosCambiarKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_AñosCambiarKeyTyped
    ...
    if (AñosCambiar.getText().trim().length() == 10) {
        evt.consume();
    }
    }//GEN-LAST:event_AñosCambiarKeyTyped
    ...
    private void AñosAñadirKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_AñosAñadirKeyTyped
        int key = evt.getKeyChar();
    ...
    if (AñosAñadir.getText().trim().length() == 10) {
        evt.consume();
    }
    }//GEN-LAST:event_AñosAñadirKeyTyped
    ...
    private javax.swing.JTextField AñosAñadir;
    private javax.swing.JTextField AñosCambiar;
    ...
    private javax.swing.JTextField DireccionAñadir;
