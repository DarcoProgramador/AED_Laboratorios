...
public class JPanelBtn {
   ...
   //Iniciando arreglo de botones y sobrecargando el metodo
    public static void JpanelArray(JPanel Panel, JPanel [][] Botones,int filas, int colum, int largo, int ancho, int posicion_x, int posicion_y, int separacion)
    {
        int x = posicion_x;
        int y = posicion_y;
