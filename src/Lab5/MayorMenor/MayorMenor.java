...
public class MayorMenor extends javax.swing.JPanel {
    
//iniciando Arrays PN
    ListaMayMen NumerosPN = new ListaMayMen(10);
    public MayorMenor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Lb_TextMostrar = new javax.swing.JLabel();
        ...
        Lb_TextMostrar.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        Lb_TextMostrar.setForeground(new java.awt.Color(255, 255, 255));
        Lb_TextMostrar.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Lb_TextMostrar.setText("Imprimir + -");
        button_Eliminar.add(Lb_TextMostrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 10, -1, -1));
    ...
    private javax.swing.JLabel Lb_TextMostrar;
